...
{
    public string $statusField= "faculty_status";
    ...
    */
    ...
    protected array $approvalSteps = [
        [
            ...
            "approvedStatus" => 3,
            "declinedStatus" => 4,
            "route" => "/academic/faculty/verification",
            "permissionRoutes" => [],
        ],
        [
            "step" => "approval",
            "approvedStatus" => 1,
            "declinedStatus" => 2,
            "route" => "/academic/faculty/approval",
            "permissionRoutes" => [],
        ]
    ];
    ...
    protected function getApprovalStepDescription($model, $step): View
    {
        ...
        $url = URL::to("/academic/faculty/view/" . $model->id);

        return view("academic::faculty.approvals." . $step, compact('record', 'url'));
    }
    ...
    {
        $relations = [
            ["relation" => "departments", "relationName" => "department"],
            ["relation" => "studentRegCourses", "relationName" => "registered student"]
        ];

        $isAllowed = $this->checkRelationsBeforeDelete($model, "Faculty", $relations);
